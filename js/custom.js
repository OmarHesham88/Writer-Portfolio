...
$(document).mouseup(function(e) {
    ...
    if (!$container.is(e.target) && ($container.has(e.target).length === 0) && (e.target !== $('#pop-form').get(0)))
    {
        $container.hide();
        $('#pop-form,#light-bg').css("display", "none");
        $('body').css({"height": "auto", "overflow": "visible"});
...
$('.parent-name > li').each(function() {
  var $this = $(this);
  if ($this.find('.father-name > li').length === 1) { //if looking for direct descendants then do .children('div').length
...
$('.parent-name > li').each(function() {
  var $this = $(this);
  if ($this.find('.father-name,.son-name').length >= 1) { //if looking for direct descendants then do .children('div').length
...
$('.father-name').each(function() {
  var $this = $(this);
  if ($this.find('.son-name').length >= 1) { //if looking for direct descendants then do .children('div').length
